...
import 'package:handyman_provider_flutter/provider/payment/component/razor_pay_services.dart';
import 'package:handyman_provider_flutter/provider/payment/component/stripe_services.dart';
  ...
  void _handleClick() async {
    ...
    if (currentTimeValue!.type == PAYMENT_METHOD_STRIPE) {
      ...
      if (currentTimeValue!.is_test == 1) {
        ...
        razorPayServices.init(razorKey: currentTimeValue!.test_value!.razor_key!, data: widget.selectedPricingPlan);
        await 1.seconds.delay;
        appStore.setLoading(false);
        razorPayServices.razorPayCheckout(widget.selectedPricingPlan.amount.validate());
      } else {
        appStore.setLoading(true);
        razorPayServices.init(razorKey: currentTimeValue!.live_value!.razor_key!, data: widget.selectedPricingPlan);
        await 1.seconds.delay;
        appStore.setLoading(false);
        razorPayServices.razorPayCheckout(widget.selectedPricingPlan.amount.validate());
      }
