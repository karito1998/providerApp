...
class ServiceDetailScreenState extends State<ServiceDetailScreen> {
  ...
  Future<void> init() async {
    ...
    getServiceDetail(req).then((value) {
      ...
      addressList = serviceDetailData.serviceDetail!.serviceAddressMapping!.map((e) {
        return e.providerAddressMapping!.address.validate();
      }).toList();

      galleryImages = serviceDetailData.serviceDetail!.imageAttchments.validate();
  ...
  Widget durationWidget() {
    return Row(
      ...
      children: [
        Text('${context.translate.hintDuration} :', style: primaryTextStyle(size: 14)),
        Text(
          '${serviceDetailData.serviceDetail!.duration.validate()} ${context.translate.lblHr}',
          style: boldTextStyle(color: primaryColor),
        ),
      ],
    ).visible(serviceDetailData.serviceDetail!.duration != null).paddingSymmetric(horizontal: 16);
  }
  ...
  Widget customerReviewWidget() {
        ...
        Row(
          ...
          children: [
            ...
            if (serviceDetailData.ratingData!.length > 4)
              TextButton(
                onPressed: () {
                  AllReviewComponent(handymanReviews: serviceDetailData.ratingData.validate()).launch(context);
                },
    ...
    ).paddingSymmetric(horizontal: 16).visible(serviceDetailData.serviceDetail!.totalRating != null);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: serviceDetailData.serviceDetail != null && serviceDetailData.serviceDetail!.isFeatured.validate(value: 0) == 1
                      ...
                      children: [
                        Stack(
                          ...
                          children: [
                            ...
                            Positioned(top: context.statusBarHeight + 8, left: 8, child: BackWidget()),
                            Positioned(
                              right: 8,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        PriceWidget(
                                          price: serviceDetailData.serviceDetail!.price.validate(),
                                          size: 24,
                                          color: primaryColor,
                                    ...
                                    8.height,
                                    if (serviceDetailData.serviceDetail!.duration.validate().isNotEmpty)
                                      TextIcon(
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (_, index) {
                                  return ServiceFaqWidget(serviceFaq: serviceFaq[index]);
                                },
                              ),
                            ],
                          ),
